...
- (void)configureProperty {
    ...
    _buttonOtherBgColor = [UIColor colorWithRed:48.0/255.0 green:95.0/255.0 blue:157.0/255.0 alpha:1];
...
- (UIColor *)buttonBgColorWithStyle:(ScottAlertActionStyle)style {
    switch (style) {
        ...
        case ScottAlertActionStyleDestructive:
            ...
            case ScottAlertActionStyleOther:
            return _buttonOtherBgColor;
        default:
            return nil;
    }
}
